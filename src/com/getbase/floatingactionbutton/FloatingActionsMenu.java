...
//					: 0;
//			mAddButton.layout(0, addButtonY, mAddButton.getMeasuredWidth(),
...
//					continue;
//
//				int childX = (mAddButton.getMeasuredWidth() - child
//						.getMeasuredWidth()) / 2;
...
//			break;
	        ...
	        mAddButton.layout(getMeasuredWidth() - mAddButton.getMeasuredWidth(), addButtonY, getMeasuredWidth(),addButtonY + mAddButton.getMeasuredHeight());
	        ...
	        for (int i = getChildCount() - 1; i >= 0; i--) {
	            ...
	            if (child instanceof ViewGroup) {
	                for (int index = 0; index < ((ViewGroup) child).getChildCount(); index++) {
	                    View childChildView = ((ViewGroup) child).getChildAt(index);

	                    if (childChildView instanceof FloatingActionButton) {
	                        childX = (mAddButton.getMeasuredWidth() - childChildView.getMeasuredWidth()) / 2;
	                    }
	                }
	            }
	            ...
	            child.layout(getMeasuredWidth() - child.getMeasuredWidth() - childX, childY, getMeasuredWidth() - childX, childY + child.getMeasuredHeight());
